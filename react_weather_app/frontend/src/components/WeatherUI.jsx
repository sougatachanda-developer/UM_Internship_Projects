  ...
  return (
    <>
      <div className='flex flex-row justify-between'>
        <div className='flex flex-col ml-6 sm:ml-8 lg:ml-10 mt-8 sm:mt-1 lg:mt-25 text-left'>
     ...
     <div className='text-7xl font-bold text-space-3 mt-3 sm:-mt-2 lg:mt-14 ml-36 sm:ml-60 lg:ml-17'>{converted_temp}°</div>
     <div className='flex text-lg font-light text-space-3 ml-35 sm:ml-61 lg:ml-16'>
